...
class filter_creator(object):
    ...
    def __init__(self):
        ...
        self.mask_csv_list = [] 
        self.img_1 = cv.imread('D:\College\EE551\Mini Project\Video_filter_JN\doctor_image\magic_circle_ccw.png', -1)
        self.img_2 = cv.imread('D:\College\EE551\Mini Project\Video_filter_JN\doctor_image\magic_circle_cw.png', -1)
        ...
        for filename in os.listdir(r'Video_filter_JN\mask_images'):
            f = os.path.join(r'Video_filter_JN\mask_images', filename)
            # print(f)
            # checking if it is a file
